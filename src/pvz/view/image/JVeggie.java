...
public abstract class JVeggie extends JComponent {
    ...
    /**
     *       * Float that represents the exact position of the JVeggie in the
     * lane (then rounded up when calling JVeggie.setLocation ()).      
     */
    private float posiX;
    /**
    ...
    private float speed;
    /**
     *       * String containing the type of veggie that this JVeggie represents
     * in order to associate him the good zombie of the model.      
     */
    private String typeZombie;
    /**
     *       * Integer representing the zombie number of the JVeggie in order to
     * associate him the good zombie of the model.      
     */
    ...
    /**
     *       * ArrayList containing sprites associated with a certain type of
     * JVeggie walking.      
     */
    ...
    /**
     *       * ArrayList containing the sprites associated with a certain type
     * of JVeggie walking leaning.      
     */
    private ArrayList<Image> walkLeaning = new ArrayList<>();
    /**
     *       * Integer representing the index of the image that the JVeggie
     * should display from a certain arrayList.      
     */
    ...
    /**
     *       * String that lets you know which zombie model this JVeggie is
     * associated with.      
     */
    private String ID;
    ...
    /**
     *       * Method initializing the zombie ID.       * @param ID The ID saved
     * in memory of this JVeggie.      
     *
     * @param ID
     */
    ...
    /**
     *       * Function returning the ID of this JVeggie.       * @return The ID
     * of the JVeggie.      
     *
     * @return
     */
    ...
    /**
     *       * Method modifying the speed of this JVeggie.       * @param speed
     * New speed of JVeggie.      
     *
     * @param speed
     */
    ...
    /**
     *       * Constructor JVeggie.       * @parameter posiX Float which
     * represents the movement speed of the JVeggie.       * @parameter
     * typeZombie String containing the type of veggie that this JVeggie
     * represents in order to associate him the good zombie of the model.      
     * * @parameter noZombie Integer representing the zombie number of the
     * JVeggie in order to associate him the good zombie of the model.       *
    ...
    /**
     *       * Method modifying and moving the JVeggie according to its zombie
    ...
    /**
     *       * Method that changes the position of the JVeggie in the Lane
