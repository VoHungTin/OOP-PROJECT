...
public class PeaShooter extends JPlant {
    ...
    /*
Â Â    * Contains the image it should display when the variable is called.     
     */
    ...
    * Long which represents the time at which the plant was created.
     ...
     */
    public PeaShooter(final PvZController controller, JZonePlantable jzp) {
        super(jzp, controller, "TirePois");
        this.tempsRecharge = controller.getFPS();
        this.dateDernierTir = controller.getTemps();
        this.charge = true;
